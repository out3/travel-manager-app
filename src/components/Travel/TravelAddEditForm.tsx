...
const formSchema = z.object({
    ...
    currency: z.string().min(1, {message: 'Currency not selected'}), // Dates must be in the right format, can also be optional
...
function TravelAddEditForm({closeDialog}: TravelAddEditFormProps) {
